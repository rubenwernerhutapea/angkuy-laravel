...
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('/img/white-logo.png') }}" />
      ...
      <header class="topbar" data-navbarbg="skin5">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin6">
            <!-- logo -->
            <a class="navbar-brand justify-content-center" href="{{ route('home') }}" target="_blank">
              <!-- Logo icon -->
              <b class="logo-icon">
                <!-- Dark Logo icon -->
            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item pt-2">
                <a class="sidebar-link waves-effect waves-dark sidebar-link {{ (request()->is('admin/user*')) ? 'active' : '' }}" href="{{ route('user.index') }}" aria-expanded="false">
                  <i class="far fa-clock" aria-hidden="true"></i>
                  <span class="hide-menu">Database admin</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a class="sidebar-link waves-effect waves-dark sidebar-link {{ (request()->is('admin/angkot*')) ? 'active' : '' }}" href="{{ route('angkot.index') }}" aria-expanded="false">
